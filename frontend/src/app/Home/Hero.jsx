        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="bg-white/20 text-white border-2 border-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-[#FF7D29] hover:-translate-y-1 transition-all duration-300 transform">
                Watch Video 📺
              </button>
            </div>
            ...
            <div className="flex justify-center lg:justify-start gap-8 pt-8">
              <div className="text-center">
                ...
                <div className="text-sm opacity-90">Happy Kids</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm opacity-90">Fun Games</div>
              </div>
            </div>
          </div>
