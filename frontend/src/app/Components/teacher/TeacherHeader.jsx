  ...
  const notifications = [
    {
      ...
      message: 'Sarah Johnson enrolled in Beginner Basics',
      time: '5 min ago',
      unread: true
    },
    {
      ...
      message: 'New 5-star review on Advanced Conversation',
      time: '1 hour ago',
      unread: true
    },
    {
      ...
      message: '12 students submitted Module 3 quiz',
      time: '2 hours ago',
      unread: false
    }
  ];
      ...
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/teacher/courses/create">
            <motion.button
              className="bg-[#FF7D29] text-white px-4 py-2 rounded-xl font-medium hover:bg-[#FF9D5C] transition-colors"
              ...
              {showProfile && (
                ...
                >
                  <div className="p-4 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">maria@zorscode.com</p>
                  </div>
                  <div className="py-2">
                    <Link href="/teacher/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      My Profile
                    </Link>
                    <Link href="/teacher/settings" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Settings
                    </Link>
                    <Link href="/teacher/help" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Help Center
                    </Link>
                  </div>
